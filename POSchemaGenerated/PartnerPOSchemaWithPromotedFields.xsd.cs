namespace POSchemaGenerated.PartnerPOSchemaPF {
    ...
    [Schema(@"POSchemaGenerated.PartnerPOSchemaPF",@"purchaseOrder")]
    [Microsoft.XLANGs.BaseTypes.PropertyAttribute(typeof(global::POSchemaGenerated.PropertySchema.TotalPOAmount), XPath = @"/*[local-name()='purchaseOrder' and namespace-uri()='POSchemaGenerated.PartnerPOSchemaPF']/@*[local-name()='TotalPOAmount' and namespace-uri()='']", XsdType = @"decimal")]
    [Microsoft.XLANGs.BaseTypes.PropertyAttribute(typeof(global::POSchemaGenerated.PropertySchema.CustomerNumber), XPath = @"/*[local-name()='purchaseOrder' and namespace-uri()='POSchemaGenerated.PartnerPOSchemaPF']/@*[local-name()='CustomerNumber' and namespace-uri()='']", XsdType = @"string")]
